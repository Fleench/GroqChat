...
SUMMARY_SYSTEM_PROMPT = "Summarize the conversation between the user and assistant as concise bullet points highlighting key ideas. It is a synopses and not a continuation. That means you are not the ai but an observer."
